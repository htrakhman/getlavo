    ...
    <>
      ...
      <div className="no-print fixed top-4 right-4 z-50 flex gap-2">
        <button
          ...
          className="rounded-lg bg-black px-4 py-2 text-sm font-medium text-[#fff] shadow hover:bg-gray-800"
        >
          Print flyer
        </button>
        <button
          onClick={() => window.close()}
          className="rounded-lg border border-gray-300 bg-[#fff] px-4 py-2 text-sm font-medium text-gray-700 shadow hover:bg-gray-50"
        >
          Close
        </button>
      </div>
