  ...
  return (
    <>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <a href="/api/exports/comms-kit?kind=poster" download className="card p-5 hover:border-gleam/40">
          <div className="font-display text-lg">Lobby poster PDF</div>
          <p className="mt-2 text-xs text-ink-500">8.5x11 starter layout</p>
        </a>
        <a href="/api/exports/comms-kit?kind=email" download className="card p-5 hover:border-gleam/40">
